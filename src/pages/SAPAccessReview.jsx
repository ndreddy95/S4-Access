    ...
    <>
        ...
        <div className="service-journey-content">
          <div className="journey-card">
            <div className="card-header"> 
              <h3 className="sub-big-heading-text-white">From Uncertainty to Clarity: Mapping Your SAP Access Management Journey</h3>
      ...
      <section className="service-solution-container">
        <div className="service-solution-content">
          ...
          <h2 className="sub-big-heading-text-white">SAP Access Management Improvement Service</h2>
